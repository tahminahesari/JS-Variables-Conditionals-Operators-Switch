...
console.log("Is 10 greater than 20? ", greaterThan);
...
const biggerThan = 10 != 11;
console.log("Is 10 bigger and equal than 11 ", biggerThan);
...
console.log("Zoet en sappig zijn niet hetzelfde ", words);
